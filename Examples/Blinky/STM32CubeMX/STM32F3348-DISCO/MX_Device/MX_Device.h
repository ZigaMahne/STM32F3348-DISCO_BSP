...
/* USART2_RX */
#define MX_USART2_RX_Pin                        PB4
#define MX_USART2_RX_GPIO_Pin                   GPIO_PIN_4
#define MX_USART2_RX_GPIOx                      GPIOB
...
/* USART2_TX */
#define MX_USART2_TX_Pin                        PB3
#define MX_USART2_TX_GPIO_Pin                   GPIO_PIN_3
#define MX_USART2_TX_GPIOx                      GPIOB
