/******************************************************************************
 * @file     vio_STM32F3348-DISCO.c
 * @brief    Virtual I/O implementation for board STM32F3348-DISCO
 * @version  V1.0.0
...
/*! \page vio_STM32F3348-DISCO Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD3)    | PB6
| vioLED1       | vioSignalOut.1 | LED green   (LD5)    | PB9
| vioLED2       | vioSignalOut.2 | LED blue    (LD6)    | PB7
| vioLED3       | vioSignalOut.3 | LED orange  (LD4)    | PB8
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTB(6),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTB(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTB(7),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED3,    GPIO_PIN_ID_PORTB(8),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
